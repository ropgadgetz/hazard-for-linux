...
def getDriver():
    ...
    for driver in drivers:
        ...
        print(f"{Fore.RED}Run setup.sh, if it has an error, please make an issue in my github.")
...
def getTheme():
    ...
    with open("/tmp/hazard_theme", 'r') as f:
        text = f.read()
...
def setTheme(new: str):
    with open("/tmp/hazard_theme", 'w'): pass
    with open("/tmp/hazard_theme", 'w') as f:
        f.write(new)
